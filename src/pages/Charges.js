  ...
  return (
    ...
    {rub.bol!==false&&<SetComponent p={rub.nom} retour={()=>setRub({bol:false,nom:''})} value={rub.value} />}
     ...
     <div className='  flex justify-between  space-x-2'>
            ...
            <button className='ml-10 bg-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center' onClick={()=>setRub(true)}>+ Ajouter Charges</button>
