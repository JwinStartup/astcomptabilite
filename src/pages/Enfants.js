...
const {personnels} = useSelector((state)=>{
  ...
  <select {...register("parent")}
             defaultValue=" " className='outline-none w-[200px] border-b-2 py-1 text-lg'>
  ...
  <select {...register("classe")} defaultValue='Science' className='outline-none w-[400px] border-b-2 py-1 text-lg'>
      ...
      <div  className="w-[400px] ">
         <label className="w-[400px] text-md font-medium ">Selectionner  des formateurs</label>Selectionner  des formateurs     
