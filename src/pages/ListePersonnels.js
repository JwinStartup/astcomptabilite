      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
        ...
        <div className="w-full flex flex-col items-center mt-6">
          <div className="w-full max-w-5xl flex flex-row items-center justify-between mb-6 px-2">
            ...
            <p className="text-2xl font-bold text-blue-800 tracking-tight">Liste du personnel</p>
            <button
              onClick={()=>navigate('/inscription/personnels')}
          ...
          {isLoader===true ? (
            ...
            <>
              {personnels.length===0 ? (
                <p className="text-center w-full text-gray-500 mt-10">Pas de personnel inscrit</p>
              ) : (
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="bg-gradient-to-r from-blue-100 via-blue-50 to-blue-200">
                          ...
                          <th className='border-b-2 text-blue-700 py-3 font-semibold'>Discipline</th>
                      ...
                      <tbody>
                        {personnels.map((value,index)=>(
                          <tr key={index} className='odd:bg-gradient-to-r odd:from-green-50 odd:to-white even:bg-white rounded-3xl h-16 m-2 items-center w-full hover:bg-green-100 transition'>
                            ...
                            <td className='font-medium text-base text-green-700 text-center py-2'>{value.discipline}</td>
                            ...
                            <td className='flex flex-row gap-2 justify-center items-center py-2'>
                              <button
                                ...
                                onClick={()=>navigate(`/modifier/personnels/${value._id}`)}
                              >
                                Modifier
                              </button>
                              <button
