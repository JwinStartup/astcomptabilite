...
.required()
  ...
  return (
   ...
   <p className='text-2xl font-semibold text-black tracking-wider mb-3'>Connectez-vous</p>             
    ...
    {errors.nom&&<p className='text-sm font-semibold text-red-500 tracking-wider my-2'>{errors.nom}</p> }
    <input {...register("password")} type='text' placeholder='Mot de passe' className='outline-none w-full border-b-2 py-1 text-lg'/>
      {errors.password&&<p className='text-sm font-semibold text-red-500 tracking-wider my-2'>{errors.password}</p> }
    </div> 
     </div>
