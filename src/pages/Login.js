  ...
  return (
    <div className='w-full flex flex-col  items-center justify-center '>
      <div className=' w-full flex mb-3'>
         ...
         <form autoComplete='off' onSubmit={handleSubmit(onSubmit)}  className='flex justify-center  mt-6 items-center flex-col space-y-4 p-9 border border-gray-400 rounded-lg shadow-lg max-w-lg sm:max-w-sm' >
