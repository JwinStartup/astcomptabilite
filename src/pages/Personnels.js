  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <div className="flex items-center px-4 pt-6 cursor-pointer" onClick={()=>navigate('/cp')} >
        ...
        <h5 className="text-2xl font-bold ml-1 tracking-tight text-gray-900">Inscription personnel</h5>
      </div>
      <form
        ...
        <div className='w-full max-w-md bg-white rounded-lg shadow-lg p-8 mt-6'>
          <div className='flex flex-col space-y-4'>
            <input {...register("nom")} type='text' placeholder='Nom'
              className='outline-none w-full border-b-2 py-2 px-2 text-lg focus:border-blue-500 transition-all duration-200'
            />
            ...
            <input {...register("email")} type='email' placeholder='Email'
              className='outline-none w-full border-b-2 py-2 px-2 text-lg focus:border-blue-500 transition-all duration-200'
            />
            <input {...register("whatshapp")} type='text' placeholder='Whatshapp'
              className='outline-none w-full border-b-2 py-2 px-2 text-lg focus:border-blue-500 transition-all duration-200'
            />
          ...
          <div className="mt-8 flex justify-center">
            {chargement==false?
              ...
              :
              <span className='flex flex-row items-center space-x-2 justify-center inline-flex items-center px-3 py-2 text-md font-medium text-center text-black'>
