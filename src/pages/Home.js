...
export default function Home() {
  ...
  {user.me?.role==='Directeur'&&<Link to='/userAdmin' className="w-52 h-52 bg-red-100 tracking-tight  text-black font-semibold rounded-3xl text-center items-center flex justify-center">
          Utilisateur
        </Link>}
         </div></div>
  )
