...
export default function Home() {
  const { user } = useContext(UserContext);
    ...
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex items-center text-lg"><GiCheckMark size={18} color="gray" />{" "}  Voir la liste des parents  et du personnels</p>
    ...
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex items-center text-lg  "> <GiCheckMark size={18} color="green" />{" "} Suivre les recettes  mensuel </p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex items-center text-lg  "> <GiCheckMark size={18} color="green" />{" "} Suivre les charges  mensuel </p>
