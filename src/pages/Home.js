...
export default function Home() {
  const { user } = useContext(UserContext);
    ...
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Créer une facture</p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Modifier une facture</p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Payer une facture</p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Telecharger une facture</p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Suppprimer une facture</p>
