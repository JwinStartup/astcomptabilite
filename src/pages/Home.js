...
export default function Home() {
  const { user } = useContext(UserContext);
    ...
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex"><GiCheckMark size={18} color="green" />Payer une facture</p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex"><GiCheckMark size={18} color="green" />Telecharger une facture ou reçue</p>
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex"><GiCheckMark size={18} color="green" />Suppprimer une facture</p>
