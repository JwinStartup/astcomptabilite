...
export default function InscriptionUser({retour}) {
  ...
  return (
         <form onSubmit={handleSubmit(onSubmit)} autoComplete='off' className='bg-white border-gray-100 shadow-md rounded-3xl  z-10 absolute top-[80px] left-[400px] flex justify-center w-[550px] mt-6 items-center flex-col space-y-4 p-9 border border-gray-400 rounded-lg shadow-lg' >
