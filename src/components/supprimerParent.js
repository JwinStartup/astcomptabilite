...
export default function SupprimerParent({retour}) {
  return (
    ...
    <p className='font-lg  tracking-tight text-[18px] text-center' >Souhaitez-vous supprimer la parent  <span className='font-lg  tracking-tight text-[18px] text-green-400 pl-1'>AKOU JEAN PAUL</span> </p>
