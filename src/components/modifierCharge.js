...
const {isLoader,personnels} = useSelector((state)=>{
  ...
  return (
    <div className='w-[500px]  border p-3 bg-white border-gray-100 shadow-md rounded-3xl   z-10 absolute top-[150px] left-[400px]'>
        ...
        <select {...register("type")} onChange={(e)=>setSelect(e.target.value)}   className='outline-none w-[420px] ml-2 border-b-2 py-1 text-lg'>
        ...
        {select==="salaire"&& <select {...register("personnel")}
              className='outline-none w-[400px] border-b-2 py-1 text-lg'>
        ...
        <select {...register("periodeAjouter")}    className='outline-none w-[420px] ml-2 border-b-2 py-1 text-lg'>
