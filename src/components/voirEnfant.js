...
export default function VoirEnfant({retour , sup}) {
  return (
    ...
    <p className='font-medium text-gray-500  tracking-tight text-[18px] text-center' >CM2 </p>
    <p className='font-medium text-gray-500  tracking-tight text-[18px] text-center' >College moderne Abobo</p>
    ...
    <button type="button" onClick={()=>sup()} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Supprimer un Eleve
    </button> </div>
    </div>
</div>
