...
useEffect(()=>{
  ...
  return (
    <div className='w-[300px]  space-y-4   items-center justify-center  border p-3 bg-white border-gray-100 shadow-md rounded-3xl z-10 absolute top-[125px] left-[125px]'>
       ...
       type="button" className=" text-red-700    font-medium border-r text-sm px-5 py-2.5 text-center inline-flex items-center ">
        ...
        <button 
       type="button" onClick={()=>download()} className=" text-blue-700    font-medium border-r text-sm px-5 py-2.5 text-center inline-flex items-center">
        Telecharger
        </button>
      {ficher!==null&&
         <WhatsappShareButton 
         url={ficher}
            ...
            >
              <button type="button"   className=" text-green-700 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center">
